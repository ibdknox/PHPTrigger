...
class Database_Mysql_Driver extends Database_Driver {
	...
	public function query($sql)
	{
		...
		profiler::logQuery($sql);
		$result = new Mysql_Result(mysql_query($sql, $this->link), $this->link, $this->db_config['object'], $sql);
		profiler::endQuery();
		return $result;
	}
	...
	public function list_fields($table)
	{
		...
		if (!isset($tables[$table]))
			throw new Exception('database.table_not_found');
